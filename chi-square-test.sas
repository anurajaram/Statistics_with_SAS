/*	Author - Anupama Rajaram
	Function - Chi-square test of independence between 2 categorical variables
...
/* 	Computing frequency distribution for 5 variables - Data exploration - commented code
...
/* 	using number of casual users to create a new categorical variable = casual_rng
	we do this by dividing the number of casual users according to % distribution
	20% = 245 users 	40% = 560 users		60% = 845 users
	80% = 1263 users	100% = 3410 users 	*/
	casual_rng = casual;	
...
/* 	similarly, changing season to just two categories, summer and winter.
	summer & fall = warm, 	fall & spring = cold 	*/ 		
...
/* 	Running the post hoc tests - There are 10 tests to be done in total 
	Hence the adjusted chi-square value should be <0.005 to be 
